...
<style>
    ...
    .field-input:focus { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(71, 232, 208, 0.08); }
...
<div class="wrapper">
    ...
    <div class="panel">
        <div class="panel-header">
            <h1 class="panel-title">Cập nhật danh mục</h1>
            <p class="panel-subtitle">// Chỉnh sửa thông tin danh mục</p>
        </div>
        <div class="panel-body">
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>/Category/update">
                ...
                <div class="field">
                    ...
                    <input type="text" class="field-input" id="name" name="name" value="<?php echo htmlspecialchars($category->getName(), ENT_QUOTES, 'UTF-8'); ?>" autocomplete="off" required>
                </div>
                <div class="actions">
